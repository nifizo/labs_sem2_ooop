...
class BPlusMinusTree:
    ...
    def insert(self, value):
        ...
        self.executor.submit(self.root.insert_non_full, value)

    def search(self, value):
        future = self.executor.submit(self.root.search, value)
...
class BPlusMinusNode:
    ...
    def split_child(self, index):
        ...
        mid_value = child.keys[mid_index]
        with self.lock, child.lock:
            self.insert_key(mid_value)
